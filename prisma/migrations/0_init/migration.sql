...
-- AddForeignKey
ALTER TABLE "interaction" ADD CONSTRAINT "interaction_end_user_id_fkey" FOREIGN KEY ("end_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "interaction" ADD CONSTRAINT "interaction_video_id_fkey" FOREIGN KEY ("video_id") REFERENCES "video"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
